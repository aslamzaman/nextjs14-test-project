...
const Edit = ({ message, id }) => {        
    ...
    const showEditForm = async () => {
        ...
        try {
            const response = await fetchOne("price", id);
            if (response) {
    ...
    const saveHandler = async (e) => {
        ...
        try {
            ...
            const response = await updateOne("price", newObject);
                        ...
                        <div className="px-6 pb-6 text-black">
                            <form onSubmit={saveHandler} >
                                <div className="grid grid-cols-1 gap-4 my-4">
                                    ...
                                    <TextEn Title="Rate" Id="rate" Change={(e) => setRate(e.target.value)} Value={rate} Chr="50" />                                        
                                </div>
