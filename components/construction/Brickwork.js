...
const Brickwork = () => {
    ...
    const resultHandler = (e) => {
        ...
        const total = (parseFloat(brick) * parseFloat(brickPrice)) + (parseFloat(cement) * parseFloat(cementPrice)) + (parseFloat(sand) * parseFloat(sandR));
        setTotalTaka(total);
    }
    ...
    return (
        <>
                ...
                <div className="fixed inset-0 py-16 bg-black bg-opacity-30 backdrop-blur-sm z-10 overflow-auto">
                    ...
                    <div className="w-11/12 md:w-1/2 mx-auto mb-10 bg-white border-2 border-gray-300 rounded-md shadow-md duration-300">
                        ...
                        <div className="px-6 md:px-6 py-2 flex justify-between items-center border-b border-gray-300">
                            <h1 className="text-xl font-bold text-blue-600">Brick Works</h1>
            ...
            <button onClick={showForm} className="px-4 py-2 bg-gray-200 hover:bg-gray-100">Brick Work</button>
        </>
    );
};
